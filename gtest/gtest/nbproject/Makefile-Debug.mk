...
${OBJECTDIR}/_ext/12bb8a06/gtest-all.o: /usr/local/share/gtest/googletest-release-1.8.0/googletest/src/gtest-all.cc
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/share/gtest/googletest-release-1.8.0/googletest -I/usr/local/share/gtest/googletest-release-1.8.0/googletest/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/12bb8a06/gtest-all.o /usr/local/share/gtest/googletest-release-1.8.0/googletest/src/gtest-all.cc

${OBJECTDIR}/_ext/12bb8a06/gtest_main.o: /usr/local/share/gtest/googletest-release-1.8.0/googletest/src/gtest_main.cc
	${MKDIR} -p ${OBJECTDIR}/_ext/12bb8a06
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/share/gtest/googletest-release-1.8.0/googletest -I/usr/local/share/gtest/googletest-release-1.8.0/googletest/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/12bb8a06/gtest_main.o /usr/local/share/gtest/googletest-release-1.8.0/googletest/src/gtest_main.cc
